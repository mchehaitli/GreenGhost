        ...
        <TabsContent value="email-campaigns" className="space-y-4">
          <Card className="p-4 md:p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className="text-2xl font-semibold mb-2">Email Campaigns</h2>
                <p className="text-muted-foreground">
                  Manage and send targeted email campaigns
                </p>
              </div>
                        ...
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">
                              Content preview: {template.html_content.substring(0, 100)}...
                            </div>
                          </div>
                          <Button 
                            size="sm" 
