          ...
          <TabsContent value="overview" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>General information about the GreenGhost Tech platform</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <section>
                  <h3 className="text-lg font-medium">About GreenGhost Tech</h3>
                  <p>
                    GreenGhost Tech is a cutting-edge landscaping technology platform serving Texas, transforming lawn care management through innovative digital solutions and user-centric design. The platform combines modern technology with traditional landscaping expertise to provide seamless, efficient, and environmentally-conscious services to homeowners and businesses.
                  </p>
                </section>
              ...
              <CardContent className="space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      The landing page features a hero section with animated elements showcasing the GreenGhost Tech mascot and primary service offerings. It includes a brief platform introduction, featured services, customer testimonials, and a call-to-action for joining the waitlist or requesting a quote.
                    </p>
                  </div>
